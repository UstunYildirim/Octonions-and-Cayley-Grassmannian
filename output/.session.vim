...
set incsearch
set ruler
set runtimepath=~/.vim,~/.vim/bundle/MatchTagAlways,~/.vim/bundle/tabular,~/.vim/bundle/vim-surround,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,~/.vim/bundle/tabular/after,~/.vim/after
set scrolloff=20
set shiftround
set shiftwidth=2
set smartindent
...
silent only
cd ~/CodeBase/MathLib/CayleyGrassmannian/output
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 eigvalsAtRegPnts.out
argglobal
silent! argdel *
$argadd eigvalsAtRegPnts.out
edit eigvalsAtRegPnts.out
